...
const ContactComponent = ({currentLang}: ContactProps) => {
  ...
  return <div className={styles.contact}>
    ...
    <div className={styles.contactInfo}>
        ...
        <a className={styles.contactLink} href="https://www.linkedin.com/in/jpabgonzalez" target="_blank"><img className={styles.icons} src="/git.svg" alt="social_media"/>GitHub</a>
        <a className={styles.contactLink} href="https://github.com/jap102321" target="_blank"><img className={styles.icons} src="/linkedin.svg" alt="social_media"/>LinkedIn</a>
